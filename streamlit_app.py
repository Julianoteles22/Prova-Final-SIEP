...
if risco != "Todos":
    ...
    X_scaled = scaler.transform(df.drop(['class', 'cluster', 'outlier', 'Probabilidade (good)', 'Predição'], axis=1))
    X = df.drop(['class', 'cluster', 'outlier', 'Probabilidade (good)', 'Predição'], axis=1)
